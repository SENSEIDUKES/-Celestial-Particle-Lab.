      ...
      {isOpen && (
        ...
        >
          ...
          <div className="p-6 border-b border-neutral-900 bg-neutral-950 flex justify-between items-center relative overflow-hidden">
            ...
            <button onClick={onClose} className="p-2 text-neutral-400 hover:text-signal rounded border border-neutral-800 hover:bg-neutral-900 transition-colors z-10" aria-label={t('close_alter_fate_panel')}>
              <X size={16} />
            </button>
          </div>
