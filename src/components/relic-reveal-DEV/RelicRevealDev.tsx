...
/**
 * DEV copy of the Relic Reveal sequence — the active UI-work copy.
 *
 * Reference (kept untouched): `src/components/relic-reveal/RelicReveal.tsx`.
...
export interface RelicRevealDevProps {
...
export function RelicRevealDev({ artifact, onClaim, onDismiss, replayKey = 0 }: RelicRevealDevProps) {
